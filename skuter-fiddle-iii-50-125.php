...
<h2>Fiddle III 50/125</h2>
<div class="container">
<div class="row-fluid">
	<div class="span5 pagination-centered">
	<img class="img-polaroid" src="resources/images/fiddle3/sym-fiddle-iii-cover.jpg" alt="скутер SYM Fiddle III"/>
	</div>
	<div class="span7">
		<h4 class="text-blue">Класическа красота и перфекционизъм</h4>
			<p>
			  Погледнат отблизо новият Fiddle предлага по-голяма икономичност, по-добра мощност, нов класически дизайн и най-нови
			  технологии.
			</p>
			<p class="text-blue" style="font-size:x-large;"> Цена: 3380лв.(50) / 3750лв.(125)</p>
		</div>
	</div>
	<div class="row-fluid">
	<div class="span6">
			...
			<table class="table table-condensed">
				...
				<tbody>
					...
					<tr class="scheda_tnt">
						...
						<td width="23%" valign="top" class="text">49.4 cm&sup3;</td>
						<td width="23%" valign="top" class="text">124.6 cm&sup3;</td>
					</tr>
					<tr class="scheda_tnt">
						<td width="30%" valign="top" height="18" class="text_bold">МАКС. ВЪРТЯЩ МОМЕНТ</td>
						<td width="23%" valign="top" class="text">3.4 Nm / 6500 rpm</td>
						<td width="23%" valign="top" class="text">8.6 Nm / 6500 rpm</td>
					</tr>
					<tr class="scheda_tnt">
					...
					<tr class="scheda_tnt">
						...
						<td width="23%" valign="top" class="text">110 / 70 - 12</td>
						<td width="23%" valign="top" class="text">110 / 70 - 12</td>
					</tr>
					<tr class="scheda_tnt">
					...
					<tr class="scheda_tnt">
						...
						<td width="23%" valign="top" class="text">1890х695х1135</td>
						<td width="23%" valign="top" class="text">1890х695х1135</td>
					</tr>
					<tr class="scheda_tnt">
					...
					<tr class="scheda_tnt">
						...
						<td valign="top" class="text">78 kg</td>
						<td valign="top" class="text">117 kg</td>
					</tr>
					<tr class="scheda_tnt">
